// Language names from Google TranslateGemma chat_template.jinja, verified against the local GGUF.
// https://huggingface.co/google/translategemma-12b-it#usage
export const TRANSLATEGEMMA_LANGUAGES: Readonly<Record<string, string>> = {
  "aa": "Afar",
  "aa-DJ": "Afar",
  "aa-ER": "Afar",
  "ab": "Abkhazian",
